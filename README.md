...
登录dfbd谷歌邮箱后，访问 [谷歌权限设置界面](https://myaccount.google.com/u/0/lesssecureapps?pli=1&pageId=none) ，启用允许不够安全的应用。
...
3、心里默念作者帅，给个`star`并把本项目推荐给更多的人（用的人越多，作者更新的动力越足），将省下的买`VPS`的巨款「 [打赏一点儿](#--捐赠-donate) 」给作者 😝
